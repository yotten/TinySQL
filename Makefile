...
test: testExecuteSQL.o ExecuteSQL.o data.o operator.o token.o column.o extension_tree_node.o column_index.o sqlQuery.o intLiteralReader.o stringLiteralReader.o tokenReader.o
	g++ -o testExecuteSQL testExecuteSQL.o ExecuteSQL.o data.o operator.o token.o column.o extension_tree_node.o column_index.o sqlQuery.o intLiteralReader.o stringLiteralReader.o tokenReader.o $(CFLAGS) $(LDFLAGS)
	./testExecuteSQL
...
ExecuteSQL.o: ExecuteSQL.cpp data.hpp operator.hpp token.hpp token_kind.hpp column.hpp extension_tree_node.hpp column_index.hpp sqlQuery.hpp inputTable.hpp resultValue.hpp intLiteralReader.hpp stringLiteralReader.hpp tokenReader.hpp
