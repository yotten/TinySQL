...
test: testExecuteSQL.o ExecuteSQL.o data.o operator.o token.o column.o
	g++ -o testExecuteSQL testExecuteSQL.o ExecuteSQL.o data.o operator.o token.o column.o $(CFLAGS) $(LDFLAGS)
	./testExecuteSQL
